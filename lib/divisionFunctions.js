mathVisual.fractionDivisionBar = (
  ...
  const bracketSVG = document.createElementNS(svgNS, "svg");
  bracketSVG.setAttribute("transform", "scale(1, 0.4)");

  bracketSVG.setAttribute("width", dividend);
  // bracketSVG.setAttribute("height", "20");
  bracketSVG.setAttribute("y", "170");
  bracketSVG.setAttribute("viewBox", "0 0 506 99");
  bracketSVG.setAttribute("fill", "none");
  bracketSVG.setAttribute("xmlns", "http://www.w3.org/2000/svg");

  const path = document.createElementNS("http://www.w3.org/2000/svg", "path");
  path.setAttribute(
    "d",
    "M2.5 1.5C50.1592 120.211 157.863 16.9452 256 96C380.692 8.71697 458.575 95.432 503.5 9"
  );
  ...
  foreignObject.appendChild(bracketSVG);
  ...
  dividendLabel.textContent = `${wholeNum1} wholes`;
