...
mathVisual.mixedNumBars = (
  ...
  if (maxWholes <= 7) {
    ...
    barWidth = ((width * 0.9) / maxWholes).toFixed(2);
  ...
  horizontalSpacing = ((width - barsPerLine * barWidth) / barsPerLine).toFixed(
    2
  );

  verticalSpacing = ((height - numLines * barHeight) / (numLines + 1)).toFixed(
    2
  );
